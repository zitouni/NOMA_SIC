...
# Title: NOMA and SIC with MPSK modulation
# Author: Rafik Zitouni
# Description: Flow Graph
# Generated: Wed Mar 14 22:03:17 2018
##################################################
...
class SIC_MPSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "NOMA and SIC with MPSK modulation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NOMA and SIC with MPSK modulation")
...
def main(top_block_cls=SIC_MPSK, options=None):
